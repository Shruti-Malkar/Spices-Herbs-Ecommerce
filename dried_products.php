...
<div class="container" style="margin-top:65px">
         <!--jumbutron start-->
        <div class="jumbotron text-center" style="background-image:url(images/flback.jpg);">
    ...
    <div class="row text-center" id="watch">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/flower1.jpg" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h4><b>Hibiscus</b></h4>
                    <p>Used as a natural hair dye or used for digestive issues,high blood pressure.</p>
                    <h5>Price :Rs 236</h5>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/flower2.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h4><b>Chamomile</b></h4>
                    <p>Used for reduce hay fever,inflammation,insomnia,wounds.</p>
                    <h5>Price :Rs 499</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/flower3.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h4><b>Lanvender Buds</b></h4>
                    <p>The flowers contain vitamins which improve skin health.</p>
                    <h5>Price :Rs 239</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                ...
                <div class="figure-caption">
                    <h4><b>Blue Pea</b></h4>
                    <p>Supports Healthy Skin,Promotes Hair Growth,Boost Brainpower</p>
                    <h5>Price :Rs 399</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
    ...
    <div class="row text-center" id="shirt">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/flower5.jpg" alt="" class="img-fluid pb-1"  >
                    <div class="figure-caption">
                    <h4><b>Calendula</b></h4>
                    <p>Used for wounds,acne,better skin,Preventing inflammation</p>
                    <h5>Price :Rs 679</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    ...
                    <div class="figure-caption">
                    <h4><b>Rose Petals</b></h4>
                    <p>Used for Skincare,Aromatherapy,Stress Relief.</p>
                    <h5>Price :Rs 265</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/flower7.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h4><b>Blue Cornflowers</b></h4>
                        <p>Used for treat fever, water retention,chest congestion.<p/>
                        <h5>Price :Rs 290</h5>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/flower8.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h4><b>Marigold Petals</b></h4>
                        <p>It reduce inflammation and protect cells from free radical damage.</p>
                        <h5>Price :Rs 440</h5>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="row text-center" id="shoes" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/flower9.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h4><b>Gajwan Phool</b></h4>
                            <p>It is used to treat illnesses and enhance general health. </p>
                            <h5>Price :Rs 740</h5>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/flower10.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h4><b>Lotus Flower</b></h4>
                            <p>Used for preventing cancer, controlling blood sugar levels.</p>
                            <h5>Price :Rs 159</h5>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/flower11.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h4><b>Neem Flower</b></h4>
                            <p>Used for reducing bile, controlling phlegm, treating intestinal worms.</p>
                            <h5>Price :Rs 340</h5>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        <img src="images/flower12.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                        <h4><b>Rose Water</b></h4>
                        <p>Improves stress levels, mood & helps with inflammation & digestion.</p>
                    <h5>Price :Rs 270</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
