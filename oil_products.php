...
<div class="container" style="margin-top:65px" >
         <!--jumbutron start-->
        <div class="jumbotron text-center" style="background-image:url('images/oilback.jpg')">
    ...
    <div class="row text-center" id="watch">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/oil1.jpg" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h4><b>Jojoba Oil</b></h4>
                    <p>Jojoba oil is used for skin for acne, sunburn & also for regrowth of hair.</p>
                    <h5>Price :Rs 225</h5>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/oil2.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h4><b>Moringa Oil</b></h4>
                    <p>It provides a protective barrier for skin & also works as an anti-aging oil. </p>
                    <h5>Price :Rs 3920</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/oil3.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h4><b>Lemon Grass Oil</b></h4>
                   <p> It promotes good night sleep and it has acne-fighting qualities.</p>
                    <h5>Price :Rs 475</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/oil4.jpg" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h4><b>Rosemary Oil</b></h4>
                 <p>It has significant antimicrobial, anti-oxidant & neuroprotective properties.</p>
                    <h5>Price :Rs 199</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
    ...
    <div class="row text-center" id="shirt">
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/oil5.jpg" alt="" class="img-fluid pb-1"  >
                    <div class="figure-caption">
                    <h4><b>Lavender Oil</b></h4>
<p>Used as anxiolytic,antioxidant & antimicrobial effects. </p>
                    <h5>Price :Rs 99</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/oil6.jpg" alt="" class="img-fluid pb-1" >
                    <div class="figure-caption">
                    <h4><b>Chamomile Oil</b></h4>
<p>Used for an anti-inflammatory, mild astringent & healing medicine.</p>
                    <h5>Price :Rs 8976</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3">
                <div class="card">
                    <img src="images/oil7.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h4><b>Tea Tree Oil</b></h4>
<p>It kill bacteria, fungus, & reduce allergic skin reactions.</p>
                        <h5>Price :Rs 359</h5>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
            ...
            <div class="col-md-3 col-6 py-3" >
                <div class="card">
                    <img src="images/oil8.jpg" alt="" class="img-fluid pb-1">
                    <div class="figure-caption">
                        <h4><b>Castor Oil</b></h4>
<p> Used as natural moisturizer and and help in wound healing.</p> 
                        <h5>Price :Rs 90</h5>
                        <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
        ...
        <div class="row text-center" id="shoes" >
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/oil9.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h4><b>Parachute Coconut Oil</b></h4>
<p>It offers long and strong hair and prevents hair fall.</p>
                            <h5>Price :Rs 156</h5>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/oil10.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h4><b>Indulekha Oil</b></h4>
<p> Used to increase blood circulation in the scalp..</p>
                            <h5>Price :Rs 432</h5>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3">
                    <div class="card">
                        <img src="images/oil11.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                            <h4><b>Kesh King Oil</b></h4>
			    <p>Used for reducing hair fall, promoting the growth of new hair.</p>
                            <h5>Price :Rs 280</h5>
                            <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                ...
                <div class="col-md-3 col-6 py-3" >
                    <div class="card">
                        <img src="images/oil12.jpg" alt="" class="img-fluid pb-1">
                        <div class="figure-caption">
                        <h4><b>Navratna Oil</b></h4>
		    <P>massage with Navratna oil relaxes the muscles.</p>
                    <h5>Price :Rs 145</h5>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
