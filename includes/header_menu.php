...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Natural Shopify</a>
                       ...
                       <li class="nav-item dropdown">
                           <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                               ...
                               <div class="dropdown-menu">
                                   <a href="products.php#HealthHerb" class="dropdown-item">Health-For Healthcare</a>
                                   <a href="dried_products.php#DriedFlowers" class="dropdown-item">Dried Flowers</a>
                                   <a href="spices_products.php#Spices" class="dropdown-item">Spices</a>
                                   <a href="oil_products.php#Oil" class="dropdown-item">Essential & Carrier Oils</a>
                               </div>
                           
                       </li>
                       <li class="nav-item"><a href="index.php" class="nav-link">Offers</a></li>
                       <li class="nav-item"><a href="abb.php" class="nav-link">About Us</a></li>
                       <?php
			...
			<li class="nav-item"><a href="profile.php"  class="nav-link " data-placement="bottom" data-toggle="popover" data-trigger="hover"><img src="https://www.freeiconspng.com/uploads/am-a-19-year-old-multimedia-artist-student-from-manila--21.png" width="25px" height="25px"></a></li>
                    </ul>
                    <?php
                } else {
                    ?>
